...
import br.com.clouzada.botaoapi.model.repository.JogoRepository
import br.com.clouzada.botaoapi.service.JogoService
...
class JogoServiceImpl @Autowired constructor(
    ...
    private fun getMinutos(jogo: Jogo): Int {
        val data = Calendar.getInstance(Locale("pt", "BR")).time
        return ((data.time - jogo.data.time) / 1000 / 60).toInt()
    }
}